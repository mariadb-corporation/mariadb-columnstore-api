...
class TestEnvironment : public ::testing::Environment {
 public:
  ...
  virtual void TearDown()
  {
    if (my_con)
    {
        if (mysql_query(my_con, "DROP TABLE mcol1563"))
...
/* Test UINT16 max is inserted correctly */
TEST(mcol1563, mcol1563)
{
    std::string table("mcol1563");
    ...
    if (mysql_query(my_con, "SELECT * FROM mcol1563"))
    ...
    ASSERT_STREQ(row[0], "32767");
    ASSERT_STREQ(row[1], "65533");
