...
import pytest, sys, os, datetime, decimal, platform, columnStoreExporter
...
def test_sql_generation():
    ...
    if platform.system() == "Windows":
        verifyAllTypes(connection, table, 9223372036854775807, "9223372036854775807, 9223372036854775807, 4294967293, 2147483647, 65533, 32767, 253, 127, 1.234, 2.34567, ZYXW, 012345678901234567890123456789, 9999-12-31, 2084-12-31 23:59:59, 123, 012345678901234567890123456789, 1, 2342, 23.420000000")
    else:
    ...
    if platform.system() == "Windows":
        verifyAllTypes(connection, table, 9223372036854775807, "9223372036854775807, 9223372036854775807, 4294967293, 2147483647, 65533, 32767, 253, 127, 1.234, 2.34567, ZYXW, 012345678901234567890123456789, 9999-12-31, 2084-12-31 23:59:59, 123.000000000, 012345678901234567890123456789, 1, 2342.000000000, 23.420000000")
    else:
